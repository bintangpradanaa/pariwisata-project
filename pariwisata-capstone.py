...
st.markdown('''<div style="font-size: 16px; text-align: center; margin-top: 30px;">
        ...
        dan devisa pariwisata meningkat, menunjukkan dampak positifnya terhadap ekonomi negara. Jumlah kunjungan wisatawan mancanegara (wisman) hampir dua 
        kali lipat meningkat menjadi 11.26 juta. Sementara itu, kenaikan kunjungan wisatawan nusantara (wisnus) tercatat relatif lebih rendah, hanya sebesar 
